      ...
      <div className="relative z-10 w-full max-w-md space-y-8">
        ...
        <div className="glass-panel p-8 rounded-lg space-y-6">
          ...
          <div style={{
            ...
            padding: '12px',
            borderRadius: '8px',
            border: '1px solid rgba(251, 113, 133, 0.2)', // Sleek rose border
            backgroundColor: 'rgba(251, 113, 133, 0.05)', // Faint rose background
            fontSize: '12px',
          }} className="max-w-md mx-auto">
            <p style={{ color: '#94A3B8', margin: 0, lineHeight: '1.5' }}>
              Need to delete your account? Log in above to delete it from your profile, or email{' '}
